package com.colins.springutils.log;
...
public class MybatisLogInterceptor implements Interceptor {
    ...
    private final static Logger log = LoggerFactory.getLogger(MybatisLogInterceptor.class);
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        log.info("{} 执行时长：{{}} ms,对应SQL：{{}}", sqlId, (sqlEndTime - sqlStartTime), sql);
        return re;
    }
